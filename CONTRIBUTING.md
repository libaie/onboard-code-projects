...
Keep changes Windows PowerShell 5.1 compatible, dependency-free, fail-closed at identity and filesystem boundaries, and limited to the smallest runnable check. Run the complete suite in the [release checklist](./docs/release-checklist.md#deterministic-gate) before submitting a pull request; CI also runs package preflight and the clean-archive release gate.
